...
export default function WorkspaceDropdown({
  ...
  return (
    <div className="relative inline-block text-left w-full">
      ...
      {isOpen && (
        <div className="origin-top-right absolute w-full rounded-md shadow-md z-50 h-[190px] bg-black/10 backdrop-blur-lg group overflow-scroll border border-muted">
          <div className="rounded-md flex flex-col">
            ...
            <CustomDialogTrigger
              ...
              description="Workspaces give you the ability to collaborate with others. You can change your workspace privacy settings after creating the workspace too."
            >
