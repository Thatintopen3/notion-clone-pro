...
export const pricingTypesEnum = pgEnum("pricing_type", [
  "one_time",
  "recurring",
]);
...
export const subscriptions = pgTable("subscriptions", {
  ...
  created: timestamp("created", { withTimezone: true, mode: "string" }).notNull().defaultNow(),
  currentPeriodStart: timestamp("current_period_start", { withTimezone: true, mode: "string" }).notNull().defaultNow(),
  currentPeriodEnd: timestamp("current_period_end", { withTimezone: true, mode: "string" }).notNull().defaultNow(),
